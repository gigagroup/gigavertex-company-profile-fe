...
import { adsStrategy as adsStrategyEn } from "@/i18n/en/ads-strategy";
...
export function getAdsStrategy(locale?: Locale) {
  return locale === "en" ? adsStrategyEn : adsStrategyId;
}

export const adsStrategyMeta = adsStrategyId.adsStrategyMeta;
export const adsChannels = adsStrategyId.adsChannels;
export const adsStrategyPrinciples = adsStrategyId.adsStrategyPrinciples;
