...
const roadmapId = {
  ...
  roadmapPillars: [
    { title: "Mesin iklan", items: ["Meta Ads", "TikTok Ads", "Google Ads"] },
    { title: "Produk AI", items: ["Autonix, Terabyte, Giga", "Ekosistem alat AI masa depan"] },
    { title: "Mesin kreatif", items: ["100+ winning creatives", "Sistem kreatif berbasis AI", "Kerangka konten viral"] },
    { title: "Infrastruktur", items: ["CRM sendiri", "Sistem otomatisasi", "Mesin analitik & data"] },
    { title: "Ekspansi global", items: ["Indonesia & Asia Tenggara", "Amerika & Eropa"] },
  ],
  roadmapVision: {
    description:
...
export const roadmapMeta = roadmapId.roadmapMeta;
export const roadmapFounder = roadmapId.roadmapFounder;
export const roadmapPhases = roadmapId.roadmapPhases;
export const roadmapPillars = roadmapId.roadmapPillars;
export const roadmapVision = roadmapId.roadmapVision;
